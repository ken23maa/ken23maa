...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Tambah Data Imunsasi</title>
	...
	<div class="card">
		<div class="card-header d-flex justify-content-between">
			<div class="header-title">
				<h4 class="card-title">Tambah Data Imunisasi</h4>
			</div>
		</div>
		<div class="card-body">
			
			<form action="prosses-tambah-data-imun.php" method="POST">
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Bidan :</label>
          <select class="form-control" id="exampleInputText1" name="imun-bidan">
          <?php 
            $query2 = 'SELECT * FROM bidan';
            $data2 = $connect->prepare($query2);
            $data2->execute();
            $tampil2=$data2->fetchAll(PDO::FETCH_OBJ);
            foreach($tampil2 as $t2){ 
          ?>
              <option value='<?= $t2->id_bidan ?>' <?php echo $t2->id_bidan?'selected':'' ?>> <?= $t2->nama_bidan ?></option>";
          <?php
            }
          ?>
          </select>
          ...
          <select class="form-control" id="exampleInputText1" name="imun-anak" >
          <?php 
            ...
            $tampil2=$data2->fetchAll(PDO::FETCH_OBJ);
            foreach($tampil2 as $t2){
              echo "<option value='$t2->id_anak'>$t2->namaanak</option>";
            }
          ?>
          </select>
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Jenis Vaksin :</label>
          ...
          ?>
				...
				<div class="form-group">
					<label class="form-label" for="exampleInputdate">Tanggal Imunisasi :</label>
					<input type="date" class="form-control" id="exampleInputdate" name="imun-tanggal">
				</div>

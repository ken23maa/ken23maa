...
require 'connection.php';
	$query = "SELECT * FROM anak WHERE id_anak=?";
	$data = $connect->prepare($query);

	$data->bindParam(1,$_GET["id_anak"]);
	$data->execute();
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Edit Data Anak</title>
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            ...
            <div class="container-fluid">
               ...
               <ul class="navbar-nav">
                  <li class="nav-item active"><a class="nav-link " href="tambah-data-imunisasi.php">Tambah Data Imunisasi</a></li>
                  <li class="nav-item"><a class="nav-link " href="data-orangtua.php"> Tambah Data Orang Tua </a></li>
                  <li class="nav-item"><a class="nav-link " href="data-balita.php"> Tambah Data Anak </a></li>
               </ul>
            </div> <!-- container-fluid.// -->
            </nav>
...
<div class="row">
	<div class="card">
        ...
        <form action="prosses-edit-anak.php" method="POST">
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">NIK</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nik" value="<?=$tampil->NIK?>">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Anak :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nama-anak" value="<?=$tampil->namaanak?>">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tempat Lahir :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tempat-lahir" value="<?=$tampil->tempatlahir?>">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tanggal Lahir :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tanggal-lahir" value="<?=$tampil->tanggallahir?>">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Jenis Kelamin :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="jk" value="<?= $tampil->jenis_kelamin?>">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Berat Badan</label>
					<input type="text" class="form-control" id="exampleInputText1" name="bb" value="<?= $tampil->berat_badan?>">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Tinggi Badan</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tb" value="<?= $tampil->tinggi_badan?>">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">anak -ke :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="anakke" value="<?= $tampil->anak_ke?>">
				</div>

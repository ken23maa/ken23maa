...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Tambah Data Penimbangan Anak</title>
	...
	<div class="card">
		<div class="card-header d-flex justify-content-between">
			<div class="header-title">
				<h4 class="card-title">Tambah Data Penimbangan</h4>
			</div>
		</div>
		<div class="card-body">
			
			<form action="prosses-tambah-data-penimbangan.php" method="POST">
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Anak :</label>
          <select class="form-control" id="exampleInputText1" name="anak">
          <?php 
            $query1 = 'SELECT * FROM anak';
            $data1 = $connect->prepare($query1);
            $data1->execute();
            $tampil1=$data1->fetchAll(PDO::FETCH_OBJ);
            foreach($tampil1 as $t1){
              echo "<option value='$t1->id_anak'>$t1->namaanak</option>";
            }
          ?>
          </select>
				</div>
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputText1" name="kepala">
          <div class="form-group">
					<label class="form-label" for="exampleInputdate">Tanggal Imunisasi :</label>
					<input type="date" class="form-control" id="exampleInputdate" name="tanggal-timbang">
				</div>
				</div>
				<div class="form-group">
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="exampleInputText1" name="bidan">
          <?php 

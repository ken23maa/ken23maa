...
$query3="SELECT * FROM bidan INNER JOIN imunisasi ON imunisasi.id_bidan=bidan.id_bidan
            ...
            WHERE bidan.username= '$_SESSION[username]'";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Tambah Data Anak</title>
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            ...
            <div class="container-fluid">
               ...
               <ul class="navbar-nav">
               <li class="nav-item"><a class="nav-link " href="tambah-data-imunisasi.php">Tambah Data Imunisasi</a></li>
               <li class="nav-item"><a class="nav-link " href="tambah-data-penimbangan.php"> Tambah Data Penimbangan </a></li>
                <li class="nav-item"><a class="nav-link " href="tambah-data-orangtua.php"> Tambah Data Orang Tua </a></li>
                <li class="nav-item"><a class="nav-link " href="tambah-data-anak.php"> Tambah Data Anak </a></li>
             </ul>
            </div> <!-- container-fluid.// -->
            </nav>
...
<div class="row">
	<div class="card">
		...
		<div class="card-body">
			...
			<form action="prosses-tambah-data-anak.php" method="POST">
        <input type='hidden' value='<?=$_GET['id']?>' name="id_ortu">
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">NIK</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nik" >
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Anak :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nama-anak" >
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tempat Lahir :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tempat-lahir">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tanggal Lahir :</label>
					<input type="date" class="form-control" id="exampleInputText1" name="tanggal-lahir">
        </div>
        <div class="form-group">
					<label class="form-label" for="exampleInputText1">Jenis Imunisasi :</label>
          <select class="form-control" id="exampleInputText1" name="imun-jenis">
          <?php 
            // $query3 = 'SELECT * FROM jenis_imunisasi';
            // $data3 = $connect->prepare($query3);
            // $data3->execute();
            // $tampil3=$data3->fetchAll(PDO::FETCH_OBJ);
            // foreach($tampil3 as $t3){
            //   echo "<option value='$t3->id_jenisimunisasi'>$t3->jenis_vaksin</option>";
            // }
          ?>
          </select>
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Berat Badan</label>
					<input type="text" class="form-control" id="exampleInputText1" name="bb">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Tinggi Badan</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tb">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">anak -ke :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="anakke">
				</div>

...
require 'connection.php';
	$query = "SELECT * from imunisasi WHERE id_imunisasi=?";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Edit Data Imunisasi</title>
	...
	<div class="card">
		<div class="card-header d-flex justify-content-between">
			<div class="header-title">
				<h4 class="card-title">Edit Data Imunisasi</h4>
			</div>
		</div>
		<div class="card-body">
			
			<form action="prosess-edit-imun.php" method="POST">
        <input type="hidden" name='imunisasi' value="<?= $tampil->id_imunisasi?>">
      <div class="form-group">
          ...
          <?php 
            ...
            foreach($tampil3 as $t3){
              ?>
              <option value='<?= $t3->id_jenisimunisasi ?>' <?php echo $tampil->id_jenisimunisasi===$t3->id_jenisimunisasi?'selected':'' ?>> <?= $t3->jenis_vaksin ?></option>";
          <?php
            }
          ?>
          </select>
				...
				<div class="form-group">
					...
					<input type="date" class="form-control" id="exampleInputdate" name="imun-tanggal" value="<?= $tampil->tanggal_imunisasi?>">

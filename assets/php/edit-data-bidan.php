...
require 'connection.php';
	$query = "SELECT * from bidan WHERE id_bidan=?";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Edit data Bidan</title>
	...
	<div class="card">
		<div class="card-header d-flex justify-content-between">
			<div class="header-title">
				<h4 class="card-title">Edit Data Bidan</h4>
			</div>
		</div>
		<div class="card-body">
			
        
      <form action="prosses-edit-bidan.php" method="POST">
            <input type='hidden' name='id_bidan' value="<?=$tampil->id_bidan?>">
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Bidan</label>
					<input type="text" class="form-control" id="exampleInputText1" name="namabidan" value="<?= $tampil->nama_bidan?>">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tempat Lahir :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tempatlahir" value="<?= $tampil->tempatlahir?>">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tanggal Lahir :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tanggallahir" value="<?= $tampil->tanggallahir?>"> 
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Jenis Kelamin :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="jk" value="<?= $tampil->jeniskelamin?>">
				</div>
                <div class="form-group">

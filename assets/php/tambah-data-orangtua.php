...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Tambah Data Orang Tua</title>
...
<div class="row">
	<div class="card">
		...
		<div class="card-body">
			...
			<form action="prosses-tambah-data-ortu.php" method="POST">
				...
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Ayah :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nama-ayah" >
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Ibu :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nama-ibu">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">No. Telephone</label>
					<input type="text" class="form-control" id="exampleInputText1" name="notelp">
				</div>
                <div class="form-group">
        ...
        <!-- <div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputText1" name="username">
				</div> -->
         <div class="form-group">
					<label class="form-label" for="exampleInputText1">Password :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="password">
				</div>

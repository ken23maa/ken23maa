...
require 'connection.php';
	$query = "SELECT * from orang_tua WHERE id_ortu=?";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Edit Data Orang Tua</title>
	...
	<div class="card">
		<div class="card-header d-flex justify-content-between">
			<div class="header-title">
				<h4 class="card-title">Edit Data Orang Tua</h4>
			</div>
		</div>
		<div class="card-body">
			
    <form action="prosses-edit-ortu.php" method="POST">
            <input type='hidden' name='id_ortu' value="<?=$tampil->id_ortu?>">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputText1" name="nama-ayah" value="<?= $tampil->namaayah?>">
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Ibu :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="nama-ibu" value="<?= $tampil->namaibu?>"> 
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">No. Telephone</label>
					<input type="text" class="form-control" id="exampleInputText1" name="notelp" value="<?= $tampil->notelp?>">
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Alamat :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="alamat" value="<?= $tampil->alamat?>">
				</div>

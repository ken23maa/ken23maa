...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>SIMPo | Tambah Data Bidan</title>
...
<div class="row">
	<div class="card">
		...
		<div class="card-body">
			...
			<form action="prosses-tambah-data-bidan.php" method="POST">
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Nama Bidan :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="namabidan" >
				</div>
				<div class="form-group">
					<label class="form-label" for="exampleInputText1">Tempat Lahir :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="tempatlahir" >
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputText1" name="jk">
				</div>
                <div class="form-group">
        ...
        <div class="header-title">
        <p><strong>*WAJIB MEMASUKKAN USERNAME DAN PASSWORD*</strong></p>
        </div>

        <div class="form-group">
					<label class="form-label" for="exampleInputText1">Username :</label>
					<input type="text" class="form-control" id="exampleInputText1" name="username" placeholder="Ex : Laras" >
				</div>
                <div class="form-group">
					<label class="form-label" for="exampleInputText1">Password : </label>
					<input type="password" class="form-control" id="exampleInputText1" name="password" >
				</div>

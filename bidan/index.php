<?php
    ...
    INNER JOIN bidan ON penimbangan.id_bidan=bidan.id_bidan WHERE  bidan.id_bidan= '$_SESSION[id]'";
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../bidan/index.php">
                            <i class="icon">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  <h1>Hello Bidan</h1>
                                  <p>Dashboard tampilan keseluruhan data, dan kinerja</p>
                              </div>
                          </div>
                      </div>
                  </div>
            ...
            <div class="card" data-aos="fade-up" data-aos-delay="1000">
               <div class="flex-wrap card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">Grafik Pemberian Penimbangan & Imunisasi</h4> 
